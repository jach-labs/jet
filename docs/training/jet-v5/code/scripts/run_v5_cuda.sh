...
NEXT=adapters/jet-v5-panel02-20260924
...
bash train_cuda.sh --init-adapter "$BASE" --base-revision 42096995f6402fde107068cf530136fe64b604f8 \
 --train work/jet-v5/smoke.jsonl --val work/jet-v5/smoke.jsonl --out adapters/jet-v5-panel02-smoke \
...
bash train_cuda.sh --init-adapter "$BASE" --base-revision 42096995f6402fde107068cf530136fe64b604f8 \
 --train data/train_v5.jsonl --val data/selection_v5.jsonl --out "$NEXT" \
 --epochs 1 --lr 1e-5 --rank 16 --grad-checkpoint --max-batch-tokens 3072 --max-state-tokens 2048 \
