...
try:
 ...
 run('smoke',[HERE/'train.py','--lr','3e-6','--out',OUT/'smoke','--smoke'])
 for name,lr in [('lr3e-6','3e-6'),('lr8e-6','8e-6')]:run(name,[HERE/'train.py','--lr',lr,'--out',OUT/name])
