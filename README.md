...
# 4. serve (--cors-origin lets the demo site at https://jach-labs.github.io call it from the browser)
JET_API_KEY=secret uv run jet-serve --base-model models/jet-1 --cors-origin https://jach-labs.github.io
